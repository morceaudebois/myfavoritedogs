...
<head>
    ...
    <title><?= $pageTitle ?? "Dog breeds tier list maker" ?> · My Favorite Dogs</title>
    <meta name="description" content="Make a list of your favorite dog breeds with My Favorite Dogs. Discover new breeds and share them with your friends."/>

    <!-- Open graph for social media -->
	<meta property="og:type" content="tool">
	<meta property="og:title" content="<?= $pageTitle ?? "Dog breeds tier list maker" ?> · My Favorite Dogs">
	<meta property="og:url" content="<?= $homeURL ?>">
	<meta property="og:image" content="<?= $thumbnail ?? $homeURL . "/src/images/large/tarkan.jpg" ?>">
...
<header>
    <div class="container">
        <a href="<?= $homeURL ?>" class="logo" title="Homepage">
