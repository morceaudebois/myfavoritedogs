        ...
        <div class="half">
            <a href="<?= $homeURL ?>" class="logo">
                ...
                <div class="text">
                    ...
                    <span id="tagline">Doggo tier list maker 🐕</span>
                </div>
            </a>

            <p>This is an <a href="https://github.com/morceaudebois/myfavoritedogs">open source project</a> that relies on donations to keep on going.<br>If you care about indie projects like these, please consider supporting me 😊</p>

            <a href="https://ko-fi.com/tahoe" class="niceBtn">Donate</a>
            <a href="mailto:mail@tahoe.be" class="niceBtn contact">Contact</a>
        </div>
...
<div id="backtotop"> <img src="<?= $homeURL ?>/src/images/arrowup.svg" alt="Back to top" width='300px' height='300px'></div>
